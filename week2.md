...
- J232_임장혁:
    > 수행한 릴레이 퀘스트: AI 없이 일일 회고 하기
    - 미션하기 바빠서 회고를 하더라도 기록하기가 쉽지 않았다.
    - 새벽에 회고를 진행하다 보니까 미션 수행하고, 회고 진행하고 하면 이미 아침인 시간도 많아서, 회고를 공유하기가 쉽지 않았다.
    -  그리고 AI를 사용하지 않고 회고를 하다보니까 진짜 ‘나’를 다 드러내는 거 같아서 회고를 공유하기가 부끄러웠다.
    - AI 의존도가 높은 것을 깨달을 수 있었다. 근데 릴레이 퀘스트를 진행하다보니 AI를 활용하먄서, AI의존도를 어떻게 하면 줄일 수 있을까에 대해 고민했다.
    - 아쉬운 게 있다면, AI가 없어도 진행이 되다보니까 아무래도 릴레이 프로젝트를 하는 이유에서 조금은 멀어진 느낌이 들었다.
    - 다음 동료분은 직접 작성해보고, AI한테도 작성해달라고 해서 비교하는 활동을 가지는 것도 좋겠다라는 생각이 들었다.
    - 서로 수행 소감을 나누면서, 짝 설계에 대한 내용이 나왔는데, 설계를 같이 진행하다 보니 새롭게 보이는 점도 있었지만 설계가 나중에 틀어지는 일도 많다는 것에 공감대를 형성했다.
    - 실제 학습 후 설계? 설계 후 학습? 등 짝 설계에 대한 답안이 뭘까에 대해 이야기를 나누었다.
    - 이번주의 아쉬움이 다들 있던 것 같아서 다음주에는 나도 보강해야겠다는 생각이 들었다.
